...
knitr::include_graphics("../../figures-source/lb-commutes.svg")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("../../figures-source/lb-commutes-occ.svg")
```
...
```{r out.width = '100%', echo = FALSE}
knitr::include_graphics("../../figures-source/lb-commutes-odmap.svg")
```
