...
ggsave(filename = "./img/lb-commutes.svg", plot = plot, width = 8, height = 5)

ggsave(filename = "./img/lb-commutes.png", plot = plot, width = 8, height = 5)
```
...
ggsave(filename = "./img/lb-commutes-occ.svg", plot = plot, width = 11, height = 7)
```
...
ggsave(filename = "./img/lb-commutes-odmap.svg", plot = plot, width = 10, height = 7)
```
